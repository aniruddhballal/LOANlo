import type { PersonalDetailsData, StepInfo } from './types';

export const REQUIRED_FIELDS_BY_STEP: { [key: number]: (keyof PersonalDetailsData)[] } = {
...
export const INITIAL_PERSONAL_DETAILS_DATA: PersonalDetailsData = {
